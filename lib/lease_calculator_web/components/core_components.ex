defmodule LeaseCalculatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LeaseCalculatorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LeaseCalculatorWeb.Gettext, "errors", msg, opts)
    end
  end
